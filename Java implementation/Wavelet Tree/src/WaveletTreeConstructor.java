...
public class WaveletTreeConstructor {
	...
	public WaveletTreeConstructor(String args[]) throws Exception
	{
		if (args.length == ARGUMENT_LENGTH)
		{
			...
			System.out.println("Memory used by program after generating is: " + Program.getKb((Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory())) + "KB");
			...
			System.out.println("\nSelect:");
			startTime = System.nanoTime();
			System.out.println("Position of " + occurrence + ". occurrence of character " +
					character + " is " + select(occurrence, character));
			endTime = System.nanoTime();
			...
			System.out.println("Memory used by program after GC: " + Program.getKb((Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory())) + "KB");
